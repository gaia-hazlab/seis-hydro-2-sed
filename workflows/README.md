...
| 42 | `python workflows/42_pr01_braid_zoom.py` | `fig33_pr01_braid_zoom.png` — PR01 braidplain zoom (@fig-pr01zoom): traced active-channel outlines pre vs post + reorganization classes, on the S2 true-color basemap. Offline from the braid cache. **10 m placeholder** — thread/bank trace needs ≈3 m (PlanetScope) or lidar DoD (Anderson 2026) |
