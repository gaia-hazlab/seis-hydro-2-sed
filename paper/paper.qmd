...
e-folding distance $r_e=v_cQ/(2\pi f)$; for $Q\approx20$ this is ~210 m at the
5–15 Hz band center and only ~13 m at 50 Hz (@fig-atten a), so bedload is
recoverable only within a few hundred metres of the channel and CC.TRON lies well
beyond reach. A first-order test on the same-source PR cluster (PR03/PR01/PR02 at
0.19/0.71/1.9 km) finds the 5–15 Hz power is *nearly distance-independent over
0.2–2 km* — far weaker than the $Q=20$ prediction (@fig-atten b) — implying the
...
array. We therefore adopt the literature $Q\approx20$ for the reach diagnostic,
restrict bedload claims to near-channel stations, and treat farther stations as
upper-distance bounds rather than attenuation-corrected flux; a clean correction
would require active-source Green's-function calibration [@bakker2020; @lagarde2021]
or amplitude-decay source location across a denser array (`eseis`; @dietze2018).
