...
![Mountain-to-sea seismic transect along the Puyallup River. Broadband stations (red triangles), suitable for ambient river-noise analysis, cluster in the glacial source reach; the lowland/coastal corridor toward Puget Sound is covered only by urban strong-motion accelerometers (gray squares).](figures/fig1_transect_map.png){#fig-map width=72%}
...
the oceanic secondary microseism rather than river flow. Full parameters are in
`config/analysis.yaml`; the pipeline and its 2026 corrections are documented in
the [review chapter](../REVIEW_2026.md).
